...
import  TypeWriter  from "../../textAnimations/typeWriter/typeWriter"
        ...
        >
          ...
          >
            ...
            >
              <Image
                ...
                relative z-[4] bg-transparent mt-[-3rem] md:mt-[-6.5rem] ${fullBodyStyles}`}
              />
            </motion.div>
          ...
          >
            <Image
              ...
              src={fullBodyImage}
              alt={altTextFullBody}
              className={`hidden md:block md:w-[55vw] rounded-2xl max-w-[535px] object-contain mx-auto bg-gray-300 bg-transparent h-auto relative z-[3] mt-auto ${fullBodyStyles}`}
            />
          </motion.div>
        </section>
      </section>
